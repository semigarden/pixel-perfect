...
const extensions = ['.jpg', '.jpeg', '.png', '.webp', '.tiff', '.svg', '.gif']; // TODO: add support for .bmp, .tga, .mp4, .webm
...
const truncateFilenameKeepExtension = (filename, maxCellWidth, scale = 1, fontFamily = 'default') => {
